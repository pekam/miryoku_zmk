...
U_MT(LGUI, Q),     U_MT(LALT, S),     U_MT(LSHFT, D),    U_MT(LCTRL, F),    &kp G,             &kp H,             U_MT(LCTRL, J),    U_MT(LSHFT, K),    U_MT(LALT, L),     U_MT(LGUI, M),     \
...
U_MT(LGUI, Y),     U_MT(LALT, I),     U_MT(LSHFT, E),    U_MT(LCTRL, A),    &kp DOT,           &kp D,             U_MT(LCTRL, S),    U_MT(LSHFT, T),    U_MT(LALT, N),     U_MT(LGUI, B),     \
...
U_MT(LGUI, A),     U_MT(LALT, R),     U_MT(LSHFT, S),    U_MT(LCTRL, T),    &kp D,             &kp H,             U_MT(LCTRL, N),    U_MT(LSHFT, E),    U_MT(LALT, I),     U_MT(LGUI, O),     \
...
&kp Q,             &kp W,             &kp F,             &kp P,             &kp B,             &kp J,             &kp L,             &kp U,             &kp Y,             &kp SQT,           \
U_MT(LGUI, A),     U_MT(LALT, R),     U_MT(LSHFT, S),    U_MT(LCTRL, T),    &kp G,             &kp K,             U_MT(LCTRL, N),    U_MT(LSHFT, E),    U_MT(LALT, I),     U_MT(LGUI, O),     \
...
U_MT(LGUI, A),     U_MT(LALT, O),     U_MT(LSHFT, E),    U_MT(LCTRL, U),    &kp I,             &kp D,             U_MT(LCTRL, H),    U_MT(LSHFT, T),    U_MT(LALT, N),     U_MT(LGUI, S),     \
...
U_MT(LGUI, S),     U_MT(LALT, H),     U_MT(LSHFT, N),    U_MT(LCTRL, T),    &kp COMMA,         &kp DOT,           U_MT(LCTRL, A),    U_MT(LSHFT, E),    U_MT(LALT, O),     U_MT(LGUI, I),     \
...
U_MT(LGUI, A),     U_MT(LALT, S),     U_MT(LSHFT, H),    U_MT(LCTRL, T),    &kp G,             &kp Y,             U_MT(LCTRL, N),    U_MT(LSHFT, E),    U_MT(LALT, O),     U_MT(LGUI, I),     \
...
&kp PG_DN,         &kp LEFT,          &kp DOWN,          &kp RIGHT,         &u_caps_word,      U_NA,              &kp LCTRL,         &kp LSHFT,         &kp LALT,          &kp LGUI,          \
...
&kp LEFT,          &kp DOWN,          &kp UP,            &kp RIGHT,         &u_caps_word,      U_NA,              &kp LCTRL,         &kp LSHFT,         &kp LALT,          &kp LGUI,          \
U_UND,             U_CUT,             U_CPY,             U_PST,             U_RDO,             U_NA,              &u_to_U_NAV,       &u_to_U_NUM,       &kp RALT,          U_NA,              \
U_NP,              U_NP,              &kp DEL,           &kp BSPC,          &kp RET,           U_NA,              U_NA,              U_NA,              U_NP,              U_NP
...
&kp LGUI,          &kp LALT,          &kp LSHFT,         &kp LCTRL,         U_NA,              &kp LEFT,          &kp DOWN,          &kp UP,            &kp RIGHT,         &u_caps_word,      \
...
U_WH_D,            U_MS_L,            U_MS_D,            U_MS_R,            U_NU,              U_NA,              &kp LCTRL,         &kp LSHFT,         &kp LALT,          &kp LGUI,          \
...
U_MS_L,            U_MS_D,            U_MS_U,            U_MS_R,            U_NU,              U_NA,              &kp LCTRL,         &kp LSHFT,         &kp LALT,          &kp LGUI,          \
U_UND,             U_CUT,             U_CPY,             U_PST,             U_RDO,             U_NA,              &u_to_U_MOUSE,     &u_to_U_SYM,       &kp RALT,          U_NA,              \
U_NP,              U_NP,              U_BTN3,            U_BTN1,            U_BTN2,            U_NA,              U_NA,              U_NA,              U_NP,              U_NP
...
&kp LGUI,          &kp LALT,          &kp LSHFT,         &kp LCTRL,         U_NA,              U_NU,              U_MS_L,            U_MS_D,            U_MS_R,            U_WH_D,            \
U_NA,              &kp RALT,          &u_to_U_SYM,       &u_to_U_MOUSE,     U_NA,              U_RDO,             U_PST,             U_CPY,             U_CUT,             U_UND,             \
U_NP,              U_NP,              U_NA,              U_NA,              U_NA,              U_BTN2,            U_BTN1,            U_BTN3,            U_NP,              U_NP

#define MIRYOKU_ALTERNATIVES_MOUSE_VI \
U_BOOT,            &u_to_U_TAP,       &u_to_U_EXTRA,     &u_to_U_BASE,      U_NA,              U_RDO,             U_PST,             U_CPY,             U_CUT,             U_UND,             \
&kp LGUI,          &kp LALT,          &kp LSHFT,         &kp LCTRL,         U_NA,              U_MS_L,            U_MS_D,            U_MS_U,            U_MS_R,            U_NU,              \
...
U_RGB_EFF,         &kp C_PREV,        &kp C_VOL_DN,      &kp C_NEXT,        U_EP_TOG,          U_NA,              &kp LCTRL,         &kp LSHFT,         &kp LALT,          &kp LGUI,          \
...
&kp C_PREV,        &kp C_VOL_DN,      &kp C_VOL_UP,      &kp C_NEXT,        U_EP_TOG,          U_NA,              &kp LCTRL,         &kp LSHFT,         &kp LALT,          &kp LGUI,          \
&u_bt_sel_0,       &u_bt_sel_1,       &u_bt_sel_2,       &u_bt_sel_3,       &u_out_tog,        U_NA,              &u_to_U_MEDIA,     &u_to_U_FUN,       &kp RALT,          U_NA,              \
U_NP,              U_NP,              &kp C_MUTE,        &kp C_PP,          &kp C_STOP,        U_NA,              U_NA,              U_NA,              U_NP,              U_NP
...
&kp LGUI,          &kp LALT,          &kp LSHFT,         &kp LCTRL,         U_NA,              U_EP_TOG,          &kp C_PREV,        &kp C_VOL_DN,      &kp C_NEXT,        U_RGB_BRI,         \
...
&kp LGUI,          &kp LALT,          &kp LSHFT,         &kp LCTRL,         U_NA,              &kp C_PREV,        &kp C_VOL_DN,      &kp C_VOL_UP,      &kp C_NEXT,        U_EP_TOG,          \
...
&kp LGUI,          &kp LALT,          &kp LSHFT,         &kp LCTRL,         U_NA,              &kp EQUAL,         &kp N4,            &kp N5,            &kp N6,            &kp SEMI,          \
...
#define NORDIC_HALF LS(NORDIC_SECTION)
#define NORDIC_EXCLAMATIONMARK LS(NUM_1)
#define NORDIC_QUOTE LS(NUM_2)
#define NORDIC_HASH LS(NUM_3)
#define NORDIC_PERCENTAGE LS(NUM_5)
#define NORDIC_AND LS(NUM_6)
#define NORDIC_SLASH LS(NUM_7)
#define NORDIC_PARENTHESES_LEFT LS(NUM_8)
#define NORDIC_PARENTHESES_RIGHT LS(NUM_9)
#define NORDIC_EQ LS(NUM_0)
#define NORDIC_QUESTIONMARK LS(NORDIC_PLUS)

#define NORDIC_AT RA(NUM_2)
#define NORDIC_POUND RA(NUM_3)
#define NORDIC_DOLLAR RA(NUM_4)
#define NORDIC_CURLY_BRACE_LEFT RA(NUM_7)
#define NORDIC_SQUARE_BRACKET_LEFT RA(NUM_8)
#define NORDIC_SQUARE_BRACKET_RIGHT RA(NUM_9)
#define NORDIC_CURLY_BRACE_RIGHT RA(NUM_0)
...
#define NORDIC_MINUS SLASH

#define NORDIC_EURO RA(E)

// /NORDIC SYMBOLS

#define MIRYOKU_ALTERNATIVES_NUM \
&kp NORDIC_ASTRK,  &kp N7,            &kp N8,            &kp N9,            &kp NORDIC_CARET,         U_NA,              &u_to_U_BASE,      &u_to_U_EXTRA,     &u_to_U_TAP,       U_BOOT,            \
&kp NORDIC_EQ,     &kp N4,            &kp N5,            &kp N6,            &kp NORDIC_PERCENTAGE,    U_NA,              &kp LCTRL,         &kp LSHFT,         &kp LALT,          &kp LGUI,          \
&kp NORDIC_PLUS,   &kp N1,            &kp N2,            &kp N3,            &kp NORDIC_HALF,          U_NA,              &u_to_U_NUM,       &u_to_U_NAV,       &kp RALT,          U_NA,              \
U_NP,              U_NP,              &kp DOT,           &kp N0,            &kp NORDIC_MINUS,         U_NA,              U_NA,              U_NA,              U_NP,              U_NP


#define MIRYOKU_ALTERNATIVES_SYM_FLIP \
U_BOOT,            &u_to_U_TAP,       &u_to_U_EXTRA,     &u_to_U_BASE,      U_NA,              &kp LBRC,          &kp AMPS,          &kp ASTRK,         &kp LPAR,          &kp RBRC,          \
&kp LGUI,          &kp LALT,          &kp LSHFT,         &kp LCTRL,         U_NA,              &kp PLUS,          &kp DLLR,          &kp PRCNT,         &kp CARET,         &kp COLON,         \
...
&kp NORDIC_BACKSLASH, &kp NORDIC_BACKTICK,     &kp NORDIC_EURO,         &kp NORDIC_DOLLAR,          U_NA,        U_NA,      &u_to_U_BASE,      &u_to_U_EXTRA,     &u_to_U_TAP,       U_BOOT,            \
...
U_NA,                 &kp NORDIC_SINGLE_QUOTE, &kp NORDIC_AT,           &kp NORDIC_HASH,            U_NA,        U_NA,      &u_to_U_SYM,       &u_to_U_MOUSE,     &kp RALT,          U_NA,              \
U_NP,                 U_NP,                    U_NA,                    U_NA,                       U_NA,        U_NA,      U_NA,              U_NA,              U_NP,              U_NP


#define MIRYOKU_ALTERNATIVES_FUN_FLIP \
U_BOOT,            &u_to_U_TAP,       &u_to_U_EXTRA,     &u_to_U_BASE,      U_NA,              &kp PSCRN,         &kp F7,            &kp F8,            &kp F9,            &kp F12,           \
&kp LGUI,          &kp LALT,          &kp LSHFT,         &kp LCTRL,         U_NA,              &kp SLCK,          &kp F4,            &kp F5,            &kp F6,            &kp F11,           \
