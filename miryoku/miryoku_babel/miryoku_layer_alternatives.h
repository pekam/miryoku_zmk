...
&hm LGUI Q,        &hm LALT S,        &hm LSHFT D,       &hm LCTRL F,       &kp G,             &kp H,             &hm LCTRL J,       &hm LSHFT K,       &hm LALT L,        &hm LGUI M,        \
...
&hm LGUI Y,        &hm LALT I,        &hm LSHFT E,       &hm LCTRL A,       &kp DOT,           &kp D,             &hm LCTRL S,       &hm LSHFT T,       &hm LALT N,        &hm LGUI B,        \
...
&hm LGUI A,        &hm LALT R,        &hm LSHFT S,       &hm LCTRL T,       &kp D,             &kp H,             &hm LCTRL N,       &hm LSHFT E,       &hm LALT I,        &hm LGUI O,        \
...
&kp Q,             &kp W,             &kp F,             &kp P,             &kp B,             &kp J,             &kp L,             &kp U,             &kp Y,             &kp SQT,           \
&hm LGUI A,        &hm LALT R,        &hm LSHFT S,       &hm LCTRL T,       &kp G,             &kp K,             &hm LCTRL N,       &hm LSHFT E,       &hm LALT I,        &hm LGUI O,        \
...
&hm LGUI A,        &hm LALT O,        &hm LSHFT E,       &hm LCTRL U,       &kp I,             &kp D,             &hm LCTRL H,       &hm LSHFT T,       &hm LALT N,        &hm LGUI S,        \
...
&hm LGUI S,        &hm LALT H,        &hm LSHFT N,       &hm LCTRL T,       &kp COMMA,         &kp DOT,           &hm LCTRL A,       &hm LSHFT E,       &hm LALT O,        &hm LGUI I,        \
...
&hm LGUI A,        &hm LALT S,        &hm LSHFT H,       &hm LCTRL T,       &kp G,             &kp Y,             &hm LCTRL N,       &hm LSHFT E,       &hm LALT O,        &hm LGUI I,        \
...
&kp LGUI,          &kp LALT,          &kp LSHFT,         &kp LCTRL,         U_NA,              &kp EQL,           &kp NUM_4,         &kp NUM_5,         &kp NUM_6,         &kp SEMI,          \
...
&kp LGUI,          &kp LALT,          &kp LSHFT,         &kp LCTRL,         U_NA,              &kp PLUS,          &kp DLLR,          &kp PRCT,          &kp CRRT,          &kp COLON,         \
